INCLUDES= -I ./include
FLAGS= -mwindows -Wall -std=gnu17
DFLAGS= -g -Wall -std=gnu17
LIB= -L .\lib
...
all:${OBJECTS} src/main.c
	gcc ${DFLAGS} ${INCLUDES} ./src/main.c ${OBJECTS} ${LIB} -lmingw32 -lSDL2main -lSDL2  -o ./bin/emuchip8 

opt:${OBJECTS} src/main.c
	gcc ${FLAGS} ${INCLUDES} ./src/main.c ${OBJECTS} ${LIB} -lmingw32 -lSDL2main -lSDL2  -o ./bin/emuchip8 
